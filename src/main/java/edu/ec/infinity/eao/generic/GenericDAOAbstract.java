...
public abstract class GenericDAOAbstract<T, PK extends Serializable> implements GenericDAO<T, PK> {
	...
	/**
	 * El parametro Criterion... lo que realmente hace es armar un objeto Criterio
	 * del tipo list por eso es que le podemos pasar n parametros al criterio de la
	 * consulta. esto se puede aplicar en muchos de nuestro metodos que no
	 * conoscamos exactamene el numero de parametros que necesitamos pasar al
	 * metodo.
	 * 
	 */
	...
	public List<T> findPageByCriteria(int firstResult, int maxResults, String[] orderList, Criterion... criterions) {
		SessionImpl session = (SessionImpl) em.getDelegate();
	...
	public List<T> findPageByCriteria(int firstResult, int maxResults, Order[] orderList, Criterion... criterions) {
		SessionImpl session = (SessionImpl) em.getDelegate();
	...
	public List<T> findPageByCriteria(int firstResult, int maxResults, String[] orderList, List<Criterion> criterions) {
		SessionImpl session = (SessionImpl) em.getDelegate();
	...
	public List nativeQueryAdvanced(StringBuffer pSql, HashMap pparams, String sqlMapping, int startFrom, int length) {
		Query query = null;
		List results = null;
