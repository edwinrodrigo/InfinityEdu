...
import edu.ec.infinity.util.DateUtils;
import edu.ec.infinity.util.dao.OrderBySqlFormula;
import edu.ec.infinity.util.dao.PostgresCriteria;
...
//					break;
//				case listagg:
//					projectionList.add(PostgresCriteria.listAgg(path, path, ","), alias);
//					break;
//				case group:
